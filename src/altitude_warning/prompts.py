...
DECIDE_SYSTEM_PROMPT = (
    ...
    "  High risk or high-risk + low-confidence requires human review.\n"
    "- Use 'auto_notify' when: risk_score > 0.6 AND confidence >= 0.75 AND should_alert=true. "
    "  Clear violation with high confidence—alert operator immediately.\n"
    "- Use 'monitor' when: risk_score <= 0.6. "
    "  Low risk; continue monitoring without alert.\n"
    "\n"
